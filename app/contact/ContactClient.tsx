      ...
      >
        ...
        >
          ...
          <p className="text-gray-300 mb-8 leading-relaxed max-w-md">
            With over <strong>15 years of experience</strong>, we specialise in
            bespoke and bridal jewellery crafted with precision, purity, and trust.
          </p>
          ...
          <div className="space-y-4 mb-10 text-gray-200 text-sm">
            <div className="flex items-center gap-3">
              <Mail size={16} />
              <a href="mailto:larixgoldkdly@gmail.com">
            ...
            <div className="flex items-start gap-3">
              <MapPin size={16} />
              <span>
                25/745, Main Road, Koduvally Kozhikode, Kerala
              </span>
            </div>
          </div>
